...
**Table Of Context**
- [0. Sky is the limit, let's bring that limit higher](#0-Sky-is-the-limit,-let's-bring-that-limit-higher)
...
```
martin@0a62aa706eb3:/# ab -c 100 -n 2000 localhost/
...
martin@0a62aa706eb3:/#
martin@0a62aa706eb3:/# puppet apply 0-the_sky_is_the_limit_not.pp
...
*[top](#0x1B-Web-stack-debugging-4)*
